            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        ...
                        <h6 class="text-muted">Kategori Tersedia</h6>
                        <!-- <div class="progress progress-sm">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        ...
                        <h6 class="text-muted">Obat Kadaluwarsa</h6>
                        <!-- <div class="progress progress-sm">
        ...
        <div class="col-md-12 col-lg-7">
            <div class="card card-table p-3">
                <div class="card-header">
                    <h4 class="card-title ">List Penjualan Terbaru</h4>
                </div>
                <div class="card-body">
